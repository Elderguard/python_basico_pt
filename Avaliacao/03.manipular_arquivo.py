...
def imprimir_nome_e_peso(lista):
    separador_blocos()
    print(f'Abaixo será listado o {lista[0][0]} e {lista[0][1]} de cada pessoa:')
    for i in range(1, len(lista)):
        print(f'O {lista[0][0]} do {i}° indivíduo da lista é {lista[i][0]} e seu peso é de {lista[i][1]}Kg.')
...
bem_vindo()
arquivo = abrir_arquivo('./Avaliacao/Peso.txt')
